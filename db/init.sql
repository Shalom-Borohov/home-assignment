...
INSERT INTO users (name, email, status) VALUES ('John Doe', 'john@example.com', 'pending');
INSERT INTO users (name, email, status) VALUES ('Jane Smith', 'jane@example.com', 'pending');
